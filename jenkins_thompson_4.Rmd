...
a)
```{r}
library("tidyverse"); library("extrafont"); library(viridis); library(MASS)
...
#definitely incorrect; need to figure out how to properly use kde2d function and exctract density

df <- data.frame(x = 1:5, y = 1:5)

dens_df <- data.frame(1:5, 1:5, kde2d(1:5, 1:5, 50)) 


ggplot(dens_df, aes(X1.5,X1.5.1))+
  geom_raster(fill)
